		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
			<div class="bg-white shadow-md rounded-lg p-8">
				...
				<p class="mb-4 text-gray-800">
					...
					plataformas digitales, sin tener que visitar una sucursal física.
				</p>
			</div>
			<div class="bg-white shadow-md rounded-lg p-8">
				...
				<p class="mb-4 text-gray-800">
					...
					con el avance de la tecnología y la creciente popularidad del comercio electrónico.
				</p>
			</div>
			<div class="bg-white shadow-md rounded-lg p-8">
				...
				<p class="mb-4 text-gray-800">
					...
					util contar con efectivo. El banco cuenta con una amplia reserva a la hora de grandes
					retiros.
				</p>
			</div>
			<div class="bg-white shadow-md rounded-lg p-8">
